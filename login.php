		    ...
		    <tr>
             ...
             <tr>
               <td colspan='5' align='center'> <input type='submit' name='Login' value='Login' /> </td>
                ...
                <center>
				 <font color='red' size='6'>Not registered yet?</font><a href='registration.html'>Signup Here</a></font>
				 </center>
...
include('connection.php');
    ...
    if(isset($_POST['Login'])){
        ...
        $sql = "select *from user_info where email = '$email' and password = '$pword'";  
